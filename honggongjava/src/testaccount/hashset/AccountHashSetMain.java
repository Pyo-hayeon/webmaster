...
public class AccountHashSetMain {

	public static void main(String[] args) {
		boolean stop = true;
		Scanner sc = new Scanner(System.in);
		AccountHashSetDao ahsd = new AccountHashSetDao();
		...
		while(stop) {
			...
			switch (key) {
				case 1: {
					...
					if(ahsd.insetAccount(acNo, name, balence)) {
				...
				case 2: {
					...
					for(AccountHashSet as : ahsd.set) {
